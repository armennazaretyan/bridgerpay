...
namespace DependencyInjectionLibrary
{
    ...
    public class ServiceAccessUnity
    {
        private List<ServiceMetadata> _servicesMetadatas;

        public ServiceAccessUnity(List<ServiceMetadata> serviceDescriptors)
        {
            _servicesMetadatas = serviceDescriptors;
        }

        public object GetService(Type serviceType)
        {
            var descriptor = _servicesMetadatas.SingleOrDefault(x => x.ServiceType == serviceType);
